...
<style>
    ...
    .task-card .task-meta { font-size: 13px; color: #666; margin-top: 4px; }
...
<div class="wrapper">
    <div class="header">
        ...
        <div class="header-title">Task Assigned</div>
    </div>
    <div class="content">
        <p>Hi {{ $notifiable->name }},</p>
        <p><strong>{{ $assignedBy->name }}</strong> assigned you a task.</p>

        <div class="task-card">
            <div class="task-title">{{ $task->title }}</div>
            <div class="task-meta">
                @if ($task->project)Project: {{ $task->project->name }} &middot; @endif
        ...
        <p style="font-size:13px; color:#666;">
            You can access this task any time from the Tasks section.
        </p>
    </div>
    <div class="footer">
